...
class HomeVegeEasy extends StatelessWidget {
  const HomeVegeEasy({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    const double lettuceLeft = (boxWidth / 2) - imageSpacing - (vege1Width / 2);

    const double greenonionLeft = (boxWidth / 2);
      ...
      child: SizedBox(
        ...
        child: Stack(
          ...
          children: [
            ...
            const Positioned(
              top: 245 + adjust,
              left: lettuceLeft + (vege1Width / 2) - (label1Width / 2),
              child: Text(
                '상추',
                style: TextStyle(
                    fontSize: 12,
            ...
            const Positioned(
              top: 245 + adjust,
              left: greenonionLeft + (vege2Width / 2) - (label2Width / 2),
              child: Text(
                '파',
                style: TextStyle(
                    fontSize: 12,
